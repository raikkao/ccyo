 ...
 * paying for execution may notee be the actual sender (as far as an application
 * is concerned).
 *
...
contract StratManager is Ownable, Pausable {
     ...
     * @param _feeRecipient new ccdao fee recipient address.
     */
...
abstract contract FeeManager is StratManager {
    ...
    uint constant public MAX_CALL_FEE = 30;
